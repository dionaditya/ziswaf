...
const MadrasahDashboardPage = () => {
    ...
    const handleSearchFunc = (e) => {
        controller.handleSearch(controller)(controller.dispatch)(ActionType.setData)
    }
    ...
    return (
        <>
            <div className="col s12">
                            ...
                            <GridItem xs={12} sm={12} md={12}>
                                <Box style={{ width: "100%" }}>
                                    <InputSearch
                                        ...
                                        onChange={(e) => {
                                            controller.handleSearchMadrasahQuery(e)(controller.dispatch)(ActionType.handleSearchMadrasah
                                            );
                                        }}
                                        onKeyPress={event => {
                                            if (event.key === 'Enter') {
                                                return controller.handleSearch(controller)(controller.dispatch)(ActionType.setData)
                                            }
                                        }}
                                    />
                                </Box>
                ...
                <GridItem xs={12} sm={12} md={12} style={{ marginBottom: '10vh' }}>
                ...
                <GridItem xs={12} sm={12} md={12}>
                    <Box display="flex" flexDirection="row" justifyContent="flex-start">
                        ...
                        <GridItem >
                            <MySelect
                                ...
                                handleChange={e => controller.handleSelectedColumn(e)(controller.dispatch)('province')}
                        ...
                        <GridItem >
                            <MySelect
                                ...
                                handleChange={e => controller.handleSelectedColumn(e)(controller.dispatch)('city')}
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="flex-end">
                        <Button style={{ backgroundColor: '#6DB400', color: '#FFFFFF' }} color="success" onClick={(e) => history.push("madrasah-input")}>
                            + Tambah Ma'had
                                    </Button>
                    </Box>
                </GridItem>
                <GridContainer>
                    <GridItem xs={12} sm={12} md={12}>
                        ...
                        >
                            <CustomizedMenus>
                                <Link to={`/dashboard/info-madrasah/${controller.tableIndex}`}
                                    style={{
                                        textDecoration: 'none',
                                        color: '#000'
                                    }}
